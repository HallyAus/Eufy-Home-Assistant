...
**v0.7.12:** eliminates concurrent-session startup storms with an Eufy-specific one-session gate and adaptive
...
excluded from live-view leases so a thumbnail cannot delay the next camera for 30 seconds.
